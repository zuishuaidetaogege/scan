...
//        }
    ...
    */
    ...
    public JsonResult<String> token(OAuth2SSOCredential credential) {
        return JsonResult.OK(AuthServiceFactory.getAuthService(Cons.DICTCODE_AUTH_TYPE.SSO.name()).applyToken(credential));
    }
    ...
    public void logoutNotify(@RequestParam(value = "userInfo") String userInfo) {
        if (V.notEmpty(userInfo)) {
            String userTypeAndId = S.substringBeforeLast(userInfo, ":"); //"IamUser:10000"
